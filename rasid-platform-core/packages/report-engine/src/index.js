...
exports.runReportRegressionSuite = exports.registerReportCapability = exports.startReportPublicationService = exports.dispatchReportTool = exports.dispatchReportAction = exports.ReportEngine = exports.createSamplePdf = exports.createSampleDocx = exports.createSamplePdfFixture = exports.createSampleDocxFixture = void 0;
...
const BlockKindSchema = zod_1.z.enum(["narrative", "metric_card", "table", "chart", "commentary"]);
const ExportTargetSchema = zod_1.z.enum(["docx", "pdf", "html"]);
const ReportBlockInputSchema = zod_1.z.object({
    block_type: BlockKindSchema,
    title: zod_1.z.string(),
    body: zod_1.z.string().default(""),
    dataset_ref: zod_1.z.string().nullable().default(null),
    query_ref: zod_1.z.string().nullable().default(null),
    field_mappings: zod_1.z.array(JsonRecordSchema).default([]),
    citations: zod_1.z.array(zod_1.z.string()).default([]),
    metric_value: zod_1.z.number().optional(),
    table_rows: zod_1.z.array(zod_1.z.array(zod_1.z.string())).default([]),
    chart_series: zod_1.z.array(zod_1.z.record(zod_1.z.union([zod_1.z.string(), zod_1.z.number()]))).default([]),
    caption: zod_1.z.string().default(""),
    page_number: zod_1.z.number().int().positive().nullable().default(null),
    source_metadata: JsonRecordSchema.default({}),
    layout_semantics: JsonRecordSchema.default({}),
    source_lineage_refs: zod_1.z.array(zod_1.z.string()).default([])
});
const ReportSectionInputSchema = zod_1.z.object({
    section_kind: zod_1.z.enum(["cover", "executive_summary", "body", "appendix"]),
    title: zod_1.z.string(),
    blocks: zod_1.z.array(ReportBlockInputSchema).min(1),
    lock_policy: zod_1.z.enum(["editable", "soft_lock", "strict_lock"]).default("editable")
});
const CreateReportRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string().optional(),
    ...
    report_type: zod_1.z.string().default("operational_report"),
    mode: zod_1.z.enum(["easy", "advanced"]).default("advanced"),
    language: zod_1.z.string().default("ar-SA"),
    template_ref: zod_1.z.string().default("template://reports/default"),
    brand_preset_ref: zod_1.z.string().default("brand://rasid/default"),
    source_refs: zod_1.z.array(zod_1.z.string()).default([]),
    sections: zod_1.z.array(ReportSectionInputSchema).min(1),
...
const UpdateMutationSchema = zod_1.z.discriminatedUnion("mutation_kind", [
    zod_1.z.object({
        mutation_kind: zod_1.z.literal("add_section"),
        section: ReportSectionInputSchema
    }),
    zod_1.z.object({
        mutation_kind: zod_1.z.literal("replace_block_content"),
        block_ref: zod_1.z.string(),
        title: zod_1.z.string().optional(),
        body: zod_1.z.string()
    }),
    zod_1.z.object({
        mutation_kind: zod_1.z.literal("rebind_block"),
        block_ref: zod_1.z.string(),
        dataset_ref: zod_1.z.string(),
        query_ref: zod_1.z.string(),
        field_mappings: zod_1.z.array(JsonRecordSchema).default([])
    }),
    zod_1.z.object({
        mutation_kind: zod_1.z.literal("reconcile_section"),
        section_title: zod_1.z.string(),
        downstream_capability: zod_1.z.enum(["presentations", "dashboards"]),
        downstream_ref: zod_1.z.string(),
        downstream_publication_ref: zod_1.z.string().nullable().default(null),
        downstream_version_ref: zod_1.z.string().nullable().default(null),
        merge_mode: zod_1.z.enum(["structural_merge", "conflict_preserving"]).default("structural_merge"),
        allow_prune: zod_1.z.boolean().default(true),
        blocks: zod_1.z.array(ReportBlockInputSchema).default([])
    })
]);
const UpdateReportRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
    mutation: UpdateMutationSchema,
    timestamp: zod_1.z.string().optional()
});
const RefreshReportRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
    selective_regeneration_refs: zod_1.z.array(zod_1.z.string()).default([]),
    timestamp: zod_1.z.string().optional()
});
const CompareReportsRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
    base_version_ref: zod_1.z.string(),
    target_version_ref: zod_1.z.string(),
    timestamp: zod_1.z.string().optional()
});
const ReviewReportRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
    reviewer_refs: zod_1.z.array(zod_1.z.string()).default([]),
    decision: zod_1.z.enum(["in_review", "changes_requested", "reviewed"]),
    comment: zod_1.z.string().default(""),
    timestamp: zod_1.z.string().optional()
});
const ApproveReportRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
...
const PublishReportRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
    target_ref: zod_1.z.string(),
    publish_to_library: zod_1.z.boolean().default(true),
    timestamp: zod_1.z.string().optional()
});
const ScheduleReportRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
    schedule_type: zod_1.z.string().default("report_refresh"),
    cadence: zod_1.z.enum(["weekly", "monthly", "on_demand", "custom"]).default("weekly"),
    timezone: zod_1.z.string().default("Asia/Riyadh"),
    next_run_at: zod_1.z.string().nullable(),
    trigger_policy: zod_1.z.object({
        trigger_mode: zod_1.z.enum(["calendar", "manual", "event"]),
        misfire_policy: zod_1.z.enum(["skip", "run_next", "run_immediately"]),
        require_fresh_inputs: zod_1.z.boolean(),
        require_approval_before_run: zod_1.z.boolean(),
        freshness_window_minutes: zod_1.z.number().int().nonnegative().nullable()
    }),
    publication_policy: zod_1.z.object({
        publish_mode: zod_1.z.enum(["never", "on_success", "on_approval", "always"]),
        publication_target_refs: zod_1.z.array(zod_1.z.string()),
        export_profile_refs: zod_1.z.array(zod_1.z.string()),
        visibility_scope_ref: zod_1.z.string().nullable()
    }),
    selective_regeneration_refs: zod_1.z.array(zod_1.z.string()).default([]),
    enabled: zod_1.z.boolean().default(true),
    timestamp: zod_1.z.string().optional()
});
const ListReportSchedulesRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string().optional(),
    include_disabled: zod_1.z.boolean().default(true)
});
const UpdateReportScheduleRequestSchema = zod_1.z.object({
    schedule_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
    next_run_at: zod_1.z.string().nullable().optional(),
    enabled: zod_1.z.boolean().optional(),
    publication_target_refs: zod_1.z.array(zod_1.z.string()).optional(),
    export_profile_refs: zod_1.z.array(zod_1.z.string()).optional(),
    visibility_scope_ref: zod_1.z.string().nullable().optional(),
    selective_regeneration_refs: zod_1.z.array(zod_1.z.string()).optional(),
    timestamp: zod_1.z.string().optional()
});
const CancelReportScheduleRequestSchema = zod_1.z.object({
    schedule_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
    reason: zod_1.z.string().default("Cancelled from report runtime."),
    timestamp: zod_1.z.string().optional()
});
const ResumeReportScheduleRequestSchema = zod_1.z.object({
    schedule_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
    next_run_at: zod_1.z.string().nullable().optional(),
    timestamp: zod_1.z.string().optional()
});
const RunReportScheduleRequestSchema = zod_1.z.object({
    schedule_id: zod_1.z.string(),
    actor_ref: zod_1.z.string().default("report-scheduler"),
    run_at: zod_1.z.string().optional()
});
const ExportReportRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
    target: ExportTargetSchema,
    timestamp: zod_1.z.string().optional()
});
const ConvertReportRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
    target_ref: zod_1.z.string().default("workspace://derived"),
    timestamp: zod_1.z.string().optional()
});
const IngestExternalReportRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string().optional(),
    tenant_ref: zod_1.z.string(),
    workspace_id: zod_1.z.string(),
    project_id: zod_1.z.string(),
    ...
    title: zod_1.z.string().optional(),
    description: zod_1.z.string().default(""),
    report_type: zod_1.z.string().default("external_ingested_report"),
    mode: zod_1.z.enum(["easy", "advanced"]).default("advanced"),
    language: zod_1.z.string().default("ar-SA"),
    template_ref: zod_1.z.string().default("template://reports/imported"),
    brand_preset_ref: zod_1.z.string().default("brand://rasid/default"),
    source_refs: zod_1.z.array(zod_1.z.string()).default([]),
    file_path: zod_1.z.string(),
    mime_type: zod_1.z.string().optional(),
    parser_hint: zod_1.z.enum(["auto", "docx", "pdf"]).default("auto"),
    permission_scope: zod_1.z
        .object({
        visibility: zod_1.z.enum(["private", "workspace", "tenant", "shared_link"]),
        allow_read: zod_1.z.boolean(),
...
const PublishDegradedReportOutputRequestSchema = zod_1.z.object({
    report_id: zod_1.z.string(),
    actor_ref: zod_1.z.string(),
    target_ref: zod_1.z.string(),
...
const ReportDispatchRequestSchema = zod_1.z.object({
    action_id: zod_1.z.string(),
    payload: zod_1.z.unknown(),
    storage_dir: zod_1.z.string().optional()
});
const ReportToolDispatchRequestSchema = zod_1.z.object({
    tool_id: zod_1.z.string(),
    payload: zod_1.z.unknown(),
    storage_dir: zod_1.z.string().optional()
});
const now = (timestamp) => timestamp ?? new Date().toISOString();
...
const localized = (value, locale = "ar-SA") => [{ value, locale, rtl: locale.startsWith("ar") }];
const baseWarning = (warningCode, summary, detail, impactedRefs = []) => ({
...
const baseFailure = (reasonCode, summary, detail, impactedRefs = []) => ({
...
const semanticVersion = (versionNumber) => `1.0.${Math.max(0, versionNumber - 1)}`;
const addCadence = (timestamp, cadence) => {
    if (!timestamp)
        return null;
    ...
    if (cadence === "monthly")
        source.setUTCDate(source.getUTCDate() + 30);
    if (cadence === "custom")
...
const transportAccessMode = (permissionScope) => permissionScope.allow_write ? "editable" : permissionScope.allow_share ? "shared" : "read_only";
const REPORT_TRANSPORT_HOST = "127.0.0.1";
let reportTransportPort = Number(process.env.RASID_REPORT_TRANSPORT_PORT ?? "0");
let reportTransportServer = null;
const servedReportPublicationRoutes = new Map();
const servedReportPublicationUrl = (publicationId, asset, accessToken) => `http://${REPORT_TRANSPORT_HOST}:${reportTransportPort}/publications/${publicationId}/${asset}?access_token=${accessToken}`;
const ensureReportTransportServer = () => {
    if (reportTransportServer) {
        return;
    }
    reportTransportServer = (0, node_http_1.createServer)(async (request, response) => {
        ...
        const filePath = parts[2] === "manifest"
            ? route.manifestPath
            : parts[2] === "state"
        ...
        try {
            ...
            response.setHeader("content-type", parts[2] === "embed" || parts[2] === "export-html"
...
const registerServedReportPublicationRoute = (publicationId, manifestPath, publishStatePath, embedPayloadPath, embedHtmlPath, exportHtmlPath) => {
    ensureReportTransportServer();
    const accessToken = (0, node_crypto_1.createHash)("sha256")
...
const rehydrateServedReportPublicationRoute = (route) => {
    const served = registerServedReportPublicationRoute(route.publication_id, route.manifest_path, route.publish_state_path, route.embed_payload_path, route.embed_html_path, route.export_html_path);
    return {
...
const rehydratePersistedReportPublications = (store) => store.listBackendPublicationIds()
...
const parseGithubOrigin = () => {
    const result = (0, node_child_process_1.spawnSync)("git", ["config", "--get", "remote.origin.url"], { encoding: "utf8" });
...
const githubApi = (args, input) => {
    const result = (0, node_child_process_1.spawnSync)("gh", ["api", ...args], { encoding: "utf8", input });
    if (result.status !== 0) {
        throw new Error(result.stderr || result.stdout || "GitHub API request failed.");
    }
    return result.stdout.trim();
};
const encodeGithubContentPath = (value) => value
    .split("/")
    .map((segment) => encodeURIComponent(segment))
    .join("/");
const lookupGithubContentSha = (target, remotePath) => {
    const result = (0, node_child_process_1.spawnSync)("gh", ["api", `repos/${target.owner}/${target.repo}/contents/${encodeGithubContentPath(remotePath)}?ref=${target.branch}`], { encoding: "utf8" });
    if (result.status !== 0)
        return null;
    const payload = JSON.parse(result.stdout);
    return payload.sha ?? null;
};
const uploadGithubContent = (target, remotePath, content, message) => {
    const encoded = Buffer.isBuffer(content)
        ? content.toString("base64")
        : content instanceof Uint8Array
            ? Buffer.from(content).toString("base64")
            : Buffer.from(content, "utf8").toString("base64");
    const sha = lookupGithubContentSha(target, remotePath);
    ...
    const response = JSON.parse(githubApi(["repos/" + target.owner + "/" + target.repo + "/contents/" + encodeGithubContentPath(remotePath), "--method", "PUT", "--input", "-"], payload));
    return {
...
const decodeXmlEntities = (value) => value
    ...
    .replace(/&quot;/g, "\"")
    .replace(/&#39;/g, "'");
const ExternalSectionBlueprintSchema = zod_1.z.object({
    title: zod_1.z.string(),
    section_kind: zod_1.z.enum(["cover", "executive_summary", "body", "appendix"]),
    blocks: zod_1.z.array(ReportBlockInputSchema).min(1)
});
const ImportFixtureProfileSchema = zod_1.z.enum(["basic", "complex"]);
const ExternalSourceParseSchema = zod_1.z.object({
    title: zod_1.z.string(),
    paragraphs: zod_1.z.array(zod_1.z.string()).default([]),
    extracted_text: zod_1.z.string().default(""),
    warning_codes: zod_1.z.array(zod_1.z.string()).default([]),
    page_count: zod_1.z.number().int().nonnegative().default(1),
    section_count: zod_1.z.number().int().nonnegative().default(0),
    table_count: zod_1.z.number().int().nonnegative().default(0),
    chart_count: zod_1.z.number().int().nonnegative().default(0),
    caption_count: zod_1.z.number().int().nonnegative().default(0),
    captions: zod_1.z.array(JsonRecordSchema).default([]),
    tables: zod_1.z.array(JsonRecordSchema).default([]),
    charts: zod_1.z.array(JsonRecordSchema).default([]),
    page_structure: zod_1.z.array(JsonRecordSchema).default([]),
    layout_semantics: zod_1.z.array(JsonRecordSchema).default([]),
    geometry_map: zod_1.z.array(JsonRecordSchema).default([]),
    page_semantics: zod_1.z.array(JsonRecordSchema).default([]),
    section_hierarchy: zod_1.z.array(JsonRecordSchema).default([]),
    block_lineage_map: zod_1.z.array(JsonRecordSchema).default([]),
    section_blueprints: zod_1.z.array(ExternalSectionBlueprintSchema).default([]),
    rendered_pages: zod_1.z.array(zod_1.z.string()).default([]),
    source_language: zod_1.z.string().nullable().default(null),
    hyperlinks: zod_1.z.array(JsonRecordSchema).default([]),
    embedded_assets: zod_1.z.array(JsonRecordSchema).default([]),
...
const pythonBridgePath = () => node_path_1.default.join(process.cwd(), "packages", "report-engine", "tools", "document_bridge.py");
const runReportDocumentBridge = (command, inputPath, extra = {}) => {
    const outputPath = extra.outputPath ??
        node_path_1.default.join((0, store_1.defaultReportEngineStorageRoot)(process.cwd()), ".tmp", `${id("bridge", command, node_path_1.default.basename(inputPath)).toLowerCase()}.json`);
    fsSync.mkdirSync(node_path_1.default.dirname(outputPath), { recursive: true });
    const args = [pythonBridgePath(), command, inputPath, outputPath];
    if (extra.renderDir)
        args.push("--render-dir", extra.renderDir);
    const result = (0, node_child_process_1.spawnSync)("python", args, { encoding: "utf8" });
    if (result.status !== 0) {
...
const fallbackImportedSections = (title, paragraphs, defaultSummary, sourceKind) => {
    const bodyParagraphs = paragraphs.length > 0 ? paragraphs : [defaultSummary];
    const grouped = bodyParagraphs.reduce((accumulator, paragraph, index) => {
...
const buildImportedSections = (title, parsed, defaultSummary, sourceKind) => {
        ...
        return parsed.section_blueprints.map((section, sectionIndex) => ({
            ...
            blocks: section.blocks.map((block, index) => ({
                ...
                source_metadata: {
                    ...
                    section_hierarchy: parsed.section_hierarchy.filter((entry) => String(entry["section_title"] ?? "") === (section.title || title)),
                    page_semantics: parsed.page_semantics.filter((entry) => entry["page_number"] === (block.page_number ?? entry["page_number"])),
                    block_lineage: parsed.block_lineage_map.filter((entry) => (Array.isArray(block.source_lineage_refs) ? block.source_lineage_refs : []).includes(String(entry["source_ref"] ?? ""))),
                    ...block.source_metadata
                },
                layout_semantics: {
                    parser_kind: sourceKind,
                    page_structure: parsed.page_structure,
                    geometry_map: parsed.geometry_map.filter((entry) => entry["page_number"] === (block.page_number ?? entry["page_number"])),
                    page_semantics: parsed.page_semantics.filter((entry) => entry["page_number"] === (block.page_number ?? entry["page_number"])),
                    hyperlinks: parsed.hyperlinks.filter((entry) => entry["page_number"] === (block.page_number ?? entry["page_number"])),
                    embedded_assets: parsed.embedded_assets.filter((entry) => entry["page_number"] === (block.page_number ?? entry["page_number"])),
...
const parseDocxExternalSource = async (filePath, storageRoot) => ExternalSourceParseSchema.parse(runReportDocumentBridge("extract-docx", filePath, {
    outputPath: node_path_1.default.join(storageRoot, ".tmp", `${id("extract", "docx", node_path_1.default.basename(filePath)).toLowerCase()}.json`)
}));
const parsePdfExternalSource = async (filePath, storageRoot) => ExternalSourceParseSchema.parse(runReportDocumentBridge("extract-pdf", filePath, {
    outputPath: node_path_1.default.join(storageRoot, ".tmp", `${id("extract", "pdf", node_path_1.default.basename(filePath)).toLowerCase()}.json`),
    renderDir: node_path_1.default.join(storageRoot, ".tmp", `${id("pdf-pages", node_path_1.default.basename(filePath)).toLowerCase()}`)
}));
...
const buildDocx = async (title, lines) => {
...
const createSampleDocxFixture = async (profile = "basic") => {
    const targetPath = node_path_1.default.join((0, store_1.defaultReportEngineStorageRoot)(process.cwd()), ".tmp", `${id("sample", "report-import", "docx", profile)}.docx`);
    const metadata = runReportDocumentBridge(profile === "complex" ? "build-complex-sample-docx" : "build-sample-docx", targetPath, {
        outputPath: node_path_1.default.join((0, store_1.defaultReportEngineStorageRoot)(process.cwd()), ".tmp", `${id("sample-meta", "report-import", "docx", profile)}.json`)
    });
    return { bytes: Uint8Array.from(fsSync.readFileSync(targetPath)), metadata };
};
exports.createSampleDocxFixture = createSampleDocxFixture;
const createSamplePdfFixture = (profile = "basic") => {
    const targetPath = node_path_1.default.join((0, store_1.defaultReportEngineStorageRoot)(process.cwd()), ".tmp", `${id("sample", "report-import", "pdf", profile)}.pdf`);
    const metadata = runReportDocumentBridge(profile === "complex" ? "build-complex-sample-pdf" : "build-sample-pdf", targetPath, {
        outputPath: node_path_1.default.join((0, store_1.defaultReportEngineStorageRoot)(process.cwd()), ".tmp", `${id("sample-meta", "report-import", "pdf", profile)}.json`)
    });
    return { bytes: Uint8Array.from(fsSync.readFileSync(targetPath)), metadata };
};
exports.createSamplePdfFixture = createSamplePdfFixture;
const createSampleDocx = async (_title, _lines) => (await (0, exports.createSampleDocxFixture)("basic")).bytes;
exports.createSampleDocx = createSampleDocx;
const createSamplePdf = (_lines) => (0, exports.createSamplePdfFixture)("basic").bytes;
exports.createSamplePdf = createSamplePdf;
const publishRemoteBundle = (bundleRoot, files, message) => {
    const githubTarget = parseGithubOrigin();
    if (!githubTarget)
        return null;
    const assets = files.reduce((accumulator, file) => {
        accumulator[file.key] = uploadGithubContent(githubTarget, `${bundleRoot}/${file.fileName}`.replace(/\\/g, "/"), file.content, message);
        return accumulator;
    }, {});
    return {
        provider: "github",
...
const schedulerBundlePath = (orchestrationId) => node_path_1.default.join((0, store_1.defaultReportEngineBackendRoot)(process.cwd()), "scheduler", orchestrationId.replace(/[^a-zA-Z0-9_-]+/g, "-"));
const publishRemoteSchedulerBundle = (orchestrationId) => {
    ...
    const files = fsSync
        ...
        fileName: entry,
        content: fsSync.readFileSync(node_path_1.default.join(root, entry))
    }));
    if (files.length === 0)
        return null;
...
const createStorageRef = (idPart, checksum = "sha256:pending") => ({
...
const createPreviewRef = (idPart, previewType) => ({
...
const createExecutionStage = (options) => {
    const evidencePack = contracts_1.EvidencePackSchema.parse({
        ...
        verification_status: options.failureReasons && options.failureReasons.length > 0
            ? "failed"
    ...
    const job = contracts_1.JobSchema.parse({
        ...
        capability: contracts_1.REPORT_CAPABILITY_ID,
    ...
    const auditEvent = contracts_1.AuditEventSchema.parse({
...
const buildCanonical = (request, reportId, timestamp, sections, contentBlocks, bindingSet) => contracts_1.CanonicalRepresentationSchema.parse({
    ...
    nodes: {
        ...
        tables: contentBlocks
            ...
            evidence_refs: [],
            editable: true,
            row_count: Array.isArray(block.content_payload["table_rows"]) ? block.content_payload["table_rows"].length : 0,
            column_count: Array.isArray(block.content_payload["table_rows"]) && Array.isArray(block.content_payload["table_rows"][0])
                ? block.content_payload["table_rows"][0].length
                : 0,
...
const persistWithStage = (store, state, stage) => ({
    ...store.persistState(state, stage),
    ...stage
});
const buildStateSnapshotForCreate = (request, reportId, timestamp) => {
    ...
    request.sections.forEach((sectionInput, sectionIndex) => {
        ...
        sectionInput.blocks.forEach((blockInput, blockIndex) => {
            ...
            if (bindingId) {
                bindings.push({
                    schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
                    schema_version: contracts_1.REPORT_SCHEMA_VERSION,
            ...
            blockRecords.push(contracts_1.ReportContentBlockSchema.parse({
                schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
                schema_version: contracts_1.REPORT_SCHEMA_VERSION,
                block_id: blockId,
                report_ref: reportId,
        ...
        sectionRecords.push(contracts_1.ReportSectionSchema.parse({
            schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
            schema_version: contracts_1.REPORT_SCHEMA_VERSION,
    ...
    const reviewState = contracts_1.ReportReviewStateSchema.parse({
        schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
        schema_version: contracts_1.REPORT_SCHEMA_VERSION,
    ...
    const approvalState = contracts_1.ReportApprovalStateSchema.parse({
        schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
        schema_version: contracts_1.REPORT_SCHEMA_VERSION,
    ...
    const bindingSet = contracts_1.ReportBindingSetSchema.parse({
        schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
        schema_version: contracts_1.REPORT_SCHEMA_VERSION,
    ...
    const layout = contracts_1.ReportLayoutSchema.parse({
        schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
        schema_version: contracts_1.REPORT_SCHEMA_VERSION,
        ...
        layout_metadata: [{ engine: "report-engine", description: request.description }]
            .concat(request.sections.map((section, index) => ({
            ...
            page_numbers: section.blocks.map((block) => block.page_number).filter((page) => typeof page === "number"),
    ...
    const version = contracts_1.ReportVersionSchema.parse({
        schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
        schema_version: contracts_1.REPORT_SCHEMA_VERSION,
    ...
    const report = contracts_1.ReportSchema.parse({
        contract: contracts_1.REPORT_CONTRACT,
        schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
        schema_version: contracts_1.REPORT_SCHEMA_VERSION,
        report_id: reportId,
...
const summarizeReportState = (state) => {
...
const reportLanguage = (state) => state.sections.flatMap((section) => section.title).find((title) => title.locale.length > 0)?.locale ?? "ar-SA";
const reportAsPresentationSource = (state) => {
        ...
        sections: state.sections.map((section, sectionIndex) => {
            ...
            return {
                ...
                tables: tableBlocks.map((block) => ({
                    ...
                    rows: Array.isArray(block.content_payload["table_rows"]) ? block.content_payload["table_rows"].map((row) => row.map(String)) : [],
                    lineage_refs: block.lineage_refs,
                    source_lineage_refs: Array.isArray(block.content_payload["source_lineage_refs"]) ? block.content_payload["source_lineage_refs"] : []
                })),
                charts: chartBlocks.map((block) => ({
                    title: block.title[0]?.value ?? block.block_id,
                    caption: String(block.content_payload["caption"] ?? ""),
                    chart_type: String(block.content_payload["layout_semantics"]?.["kind"] ?? "bar"),
                    series: Array.isArray(block.content_payload["chart_series"])
                        ? block.content_payload["chart_series"]
                        : [],
                    lineage_refs: block.lineage_refs,
                    source_lineage_refs: Array.isArray(block.content_payload["source_lineage_refs"]) ? block.content_payload["source_lineage_refs"] : []
                })),
                metrics: metricBlocks.map((block) => ({
                    ...
                    unit: String(block.content_payload["source_metadata"]?.["metric_unit"] ?? "")
                }))
            };
        })
    };
};
const inferDatasetProfilesFromReport = (state) => {
    ...
    state.bindingSet.bindings.forEach((binding) => {
        ...
        const existing = byDataset.get(binding.dataset_ref) ?? {
            ...
            measure_fields: new Set(),
            available_filter_fields: new Set(),
...
const reportAsDashboardBlueprints = (state) => state.contentBlocks.map((block, index) => {
    const binding = state.bindingSet.bindings.find((entry) => entry.target_block_ref === block.block_id);
    const layoutSemantics = block.content_payload["layout_semantics"] ?? {};
    const sourceMetadata = block.content_payload["source_metadata"] ?? {};
    const widget_type = block.block_type === "metric_card"
        ? "kpi_card"
...
const reportAsDashboardFilters = (state) => inferDatasetProfilesFromReport(state)
    .map((profile, index) => {
...
const reportAsDashboardRefreshPolicy = (state) => {
    ...
    return {
        ...
        schedule_kind: activeSchedule?.cadence === "weekly"
            ? "weekly"
        ...
        stale_after_minutes: Number(activeSchedule?.trigger_policy?.["freshness_window_minutes"] ?? 60) || 60,
        allow_selective_refresh: true,
        last_refresh_at: state.bindingSet.last_refresh_at
    };
};
const diffRefs = (before, after) => after.filter((entry) => !before.includes(entry));
const removedRefs = (before, after) => before.filter((entry) => !after.includes(entry));
const normalizedText = (value) => value.trim().replace(/\s+/g, " ").toLowerCase();
const existingBlockTitle = (block) => block.title[0]?.value ?? block.block_id;
const existingBlockSourceLineageRefs = (block) => Array.isArray(block.content_payload["source_lineage_refs"]) ? block.content_payload["source_lineage_refs"] : [];
const blockInputSourceLineageRefs = (block) => Array.isArray(block.source_lineage_refs) ? block.source_lineage_refs : [];
const blockFingerprint = (title, payload) => hashValue(JSON.stringify({
    title,
    body: payload["body"] ?? "",
...
const inputBlockFingerprint = (block) => hashValue(JSON.stringify({
    title: block.title,
    body: block.body,
...
const presentationBackSyncBlocks = (bundle, publication, timestamp) => {
    const storyboardRecords = zod_1.z.array(JsonRecordSchema).catch([]).parse(bundle.storyboard);
...
const dashboardBackSyncBlocks = (workflow, publication, timestamp) => {
    const blocks = [
        {
            block_type: "commentary",
    ...
    workflow.dashboard.widgets.slice(0, 4).forEach((widget) => {
        ...
        const tableRows = widget.widget_type === "table"
            ? [
            ...
            : [];
        blocks.push({
            block_type: widget.widget_type === "kpi_card"
                ? "metric_card"
            ...
            chart_series: widget.widget_type.includes("chart")
...
class ReportEngine {
    constructor(options = {}) {
        this.store = new store_1.ReportEngineStore(options.storageDir ?? (0, store_1.defaultReportEngineStorageRoot)());
    }
    createPresentationEngine() {
        return new presentations_engine_1.PresentationEngine();
    }
    createDashboardEngine() {
        return new dashboard_engine_1.DashboardEngine({
            storageDir: node_path_1.default.join(this.store.rootDir, "integrations", "dashboard-engine")
        });
    }
    applyBackSyncSection(reportId, actorRef, downstreamCapability, downstreamRef, downstreamPublicationRef, downstreamVersionRef, sectionTitle, blocks, timestamp) {
        ...
        const conflictRefs = result.contentBlocks
            .filter((block) => Array.isArray(block.content_payload["source_metadata"]?.["reconciliation_conflicts"]))
            .map((block) => block.block_id);
        const matchedSection = priorRecord?.matched_section_ref && result.sections.find((section) => section.section_id === priorRecord.matched_section_ref)
    ...
    async ingestExternalReport(input) {
        ...
        const reportId = request.report_id ??
            id("report", request.title ?? parsed.title, node_path_1.default.basename(request.file_path, node_path_1.default.extname(request.file_path)));
        ...
        const created = this.createReport({
            ...
            permission_scope: request.permission_scope,
            sections: buildImportedSections(request.title ?? parsed.title, parsed, `Imported ${parserKind.toUpperCase()} source ${node_path_1.default.basename(request.file_path)}`, parserKind),
            timestamp
        });
        const current = this.store.loadState(reportId);
        const sourceArtifact = this.store.writeAuxiliaryArtifact(reportId, contracts_1.ArtifactSchema.parse({
            contract: (0, contracts_1.contractEnvelope)("artifact"),
        ...
        }), node_path_1.default.join("imports", ingestId, `source${parserKind === "pdf" ? ".pdf" : ".docx"}`), await node_fs_1.promises.readFile(request.file_path));
        const parsedArtifact = this.store.writeAuxiliaryArtifact(reportId, contracts_1.ArtifactSchema.parse({
            contract: (0, contracts_1.contractEnvelope)("artifact"),
            ...
            tenant_ref: current.reportArtifact.tenant_ref,
            permission_scope: current.reportArtifact.permission_scope
        }), node_path_1.default.join("imports", ingestId, "parsed-structure.json"), JSON.stringify(parsed, null, 2));
        const renderedPageArtifacts = parsed.rendered_pages.map((renderedPagePath, index) => this.store.writeAuxiliaryArtifact(reportId, contracts_1.ArtifactSchema.parse({
            contract: (0, contracts_1.contractEnvelope)("artifact"),
            ...
            tenant_ref: current.reportArtifact.tenant_ref,
            permission_scope: current.reportArtifact.permission_scope
        }), node_path_1.default.join("imports", ingestId, "pages", node_path_1.default.basename(renderedPagePath)), fsSync.readFileSync(renderedPagePath)));
        const ingestRecord = this.store.saveIngestRecord({
            ...
            original_file_name: node_path_1.default.basename(request.file_path),
        ...
        const state = {
            ...current,
            layout: contracts_1.ReportLayoutSchema.parse({
                ...current.layout,
                layout_metadata: [
            ...
            derivedArtifacts: [
                ...current.derivedArtifacts.filter((artifact) => artifact.artifact_id !== sourceArtifact.artifact_id &&
        ...
        const stage = createExecutionStage({
            ...
            warnings: parsed.warning_codes.map((warningCode) => baseWarning(warningCode, "External ingest warning.", `Parser emitted ${warningCode}.`, [sourceArtifact.artifact_id])),
            lineageEdges: [
                {
                ...
                ...state.contentBlocks.flatMap((block) => (Array.isArray(block.content_payload["source_lineage_refs"]) ? block.content_payload["source_lineage_refs"] : []).map((lineageRef, index) => ({
    ...
    updateReport(input) {
        ...
        if (request.mutation.mutation_kind === "add_section") {
            ...
            request.mutation.section.blocks.forEach((blockInput, blockIndex) => {
                ...
                blocks.push(contracts_1.ReportContentBlockSchema.parse({
                    schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
                    schema_version: contracts_1.REPORT_SCHEMA_VERSION,
                    block_id: blockId,
            ...
            sections.push(contracts_1.ReportSectionSchema.parse({
                schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
                schema_version: contracts_1.REPORT_SCHEMA_VERSION,
                section_id: sectionId,
                report_ref: current.report.report_id,
        ...
        if (request.mutation.mutation_kind === "reconcile_section") {
            ...
            const priorRecord = this.store
                ...
                .sort((left, right) => right.synced_at.localeCompare(left.synced_at))[0];
            let targetSection = (priorRecord?.matched_section_ref
            ...
            if (!targetSection) {
                const sectionId = id("report-section", current.report.report_id, sections.length + 1);
                targetSection = contracts_1.ReportSectionSchema.parse({
                    schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
                    schema_version: contracts_1.REPORT_SCHEMA_VERSION,
                    section_id: sectionId,
                    report_ref: current.report.report_id,
            ...
            const removedBindingRefs = new Set();
            const nextBlockRefs = [];
            const matchBlock = (blockInput) => sectionBlocks.find((candidate) => {
                if (consumedBlockIds.has(candidate.block_id))
                    return false;
                ...
                if (candidateLineage.some((entry) => incomingLineage.includes(entry)))
                    return true;
            ...
            mutation.blocks.forEach((blockInput, blockIndex) => {
                ...
                if (matched) {
                    ...
                    const currentPayload = clone(matched.content_payload);
                    const currentSourceMetadata = (currentPayload["source_metadata"] ?? {});
                    ...
                    const priorConflicts = Array.isArray(currentSourceMetadata["reconciliation_conflicts"])
                        ? [...currentSourceMetadata["reconciliation_conflicts"]]
                        : [];
                    const hasConflict = mutation.merge_mode === "conflict_preserving" &&
                    ...
                    if (hasConflict) {
                        matched.content_payload = {
                            ...
                            layout_semantics: {
                                ...((currentPayload["layout_semantics"] ?? {})),
            ...
            blocks.length = 0;
            blocks.push(...nextBlocks.map((block, index) => contracts_1.ReportContentBlockSchema.parse({ ...block, order_index: block.section_ref === targetSection.section_id ? nextBlockRefs.indexOf(block.block_id) : block.order_index })));
        ...
        if (request.mutation.mutation_kind === "replace_block_content") {
            ...
            if (!target)
                throw new Error(`Unknown report block: ${mutation.block_ref}`);
        ...
        const reconcileSectionTitle = request.mutation.mutation_kind === "reconcile_section" ? request.mutation.section_title : null;
        const bindingSet = contracts_1.ReportBindingSetSchema.parse({
            ...current.bindingSet,
            version_ref: nextReportVersionId,
            dataset_binding_refs: bindings.map((binding) => binding.binding_id),
            bindings,
            selective_regeneration_refs: request.mutation.mutation_kind === "rebind_block"
                ? [request.mutation.block_ref]
                : request.mutation.mutation_kind === "reconcile_section"
                    ? (() => {
                        const targetSectionId = sections.find((section) => normalizedText(section.title[0]?.value ?? "") === normalizedText(reconcileSectionTitle ?? ""))?.section_id;
                        return blocks
        ...
        const layout = contracts_1.ReportLayoutSchema.parse({ ...current.layout, version_ref: nextReportVersionId });
        ...
        }, report.report_id, timestamp, sections, blocks, bindingSet);
        const state = {
            ...current,
            report,
            version,
            ...
            approvalState,
            canonical,
            versionArtifact: contracts_1.ArtifactSchema.parse({
    ...
    refreshReport(input) {
        ...
        const blocks = clone(current.contentBlocks).map((block) => {
            const shouldRefresh = request.selective_regeneration_refs.length === 0 ||
            ...
            block.version_ref = nextReportVersionId;
            if (!shouldRefresh || block.binding_refs.length === 0)
                return block;
            const payload = clone(block.content_payload);
            payload["last_refreshed_at"] = timestamp;
            if (block.block_type === "metric_card")
                payload["metric_value"] = Number(payload["metric_value"] ?? 0) + 5;
            if (block.block_type === "chart")
                payload["chart_series"] = [{ label: "Current", value: 72 }, { label: "Target", value: 68 }];
        ...
        const reviewState = contracts_1.ReportReviewStateSchema.parse({ ...current.reviewState, version_ref: nextReportVersionId, state: "draft" });
        const approvalState = contracts_1.ReportApprovalStateSchema.parse({
            ...current.approvalState,
            version_ref: nextReportVersionId,
            state: current.approvalState.state === "approved" ? "approved" : "pending",
        ...
        const canonical = contracts_1.CanonicalRepresentationSchema.parse({
            ...current.canonical,
        ...
        const warnings = request.selective_regeneration_refs.length > 0
    ...
    compareReports(input) {
        ...
        const diffArtifact = this.store.writeAuxiliaryArtifact(request.report_id, contracts_1.ArtifactSchema.parse({
            contract: (0, contracts_1.contractEnvelope)("artifact"),
            ...
            tenant_ref: current.reportArtifact.tenant_ref,
            permission_scope: current.reportArtifact.permission_scope
        }), node_path_1.default.join("diffs", `${request.base_version_ref}-${request.target_version_ref}.json`), JSON.stringify({
        ...
        const diff = contracts_1.ReportDiffMetadataSchema.parse({
            schema_namespace: contracts_1.REPORT_SCHEMA_NAMESPACE,
            schema_version: contracts_1.REPORT_SCHEMA_VERSION,
    ...
    async exportReport(input) {
        ...
        const exportArtifact = this.store.writeAuxiliaryArtifact(request.report_id, contracts_1.ArtifactSchema.parse({
            contract: (0, contracts_1.contractEnvelope)("artifact"),
            ...
            tenant_ref: current.reportArtifact.tenant_ref,
            permission_scope: current.reportArtifact.permission_scope
        }), node_path_1.default.join("exports", request.target, fileName), payload);
        const sourceState = {
            ...current,
            report: contracts_1.ReportSchema.parse({
                ...current.report,
                updated_at: timestamp
            }),
            reportArtifact: contracts_1.ArtifactSchema.parse({
    ...
    async convertReportToPresentation(input) {
        ...
        const backSync = this.applyBackSyncSection(request.report_id, request.actor_ref, "presentations", parity.bundle.deck.deck_id, nativePublication.publication.publication_id, parity.bundle.version.version_ref.version_id, "Presentation Back-Sync", presentationBackSyncBlocks(parity.bundle, nativePublication, timestamp), timestamp);
    ...
    async convertReportToDashboard(input) {
        const request = ConvertReportRequestSchema.parse(input);
        const timestamp = now(request.timestamp);
        const current = this.store.loadState(request.report_id);
        ...
        const interactionExecution = interactionSeedFilter && workflow.dashboard.widgets.length > 1
            ...
            : null;
        const interactedWorkflow = interactionExecution
        ...
        const refreshedWorkflow = dueRefreshes.find((entry) => entry.dashboard.dashboard_id === interactedWorkflow.dashboard.dashboard_id) ?? interactedWorkflow;
        ...
        const backSync = this.applyBackSyncSection(request.report_id, request.actor_ref, "dashboards", refreshedWorkflow.dashboard.dashboard_id, nativePublication.publication.publication_id, refreshedWorkflow.version.version_id, "Dashboard Back-Sync", dashboardBackSyncBlocks(refreshedWorkflow, nativePublication, timestamp), timestamp);
        const syncedState = this.store.loadState(request.report_id);
        const state = {
            ...syncedState,
            derivedArtifacts: [...syncedState.derivedArtifacts.filter((item) => item.artifact_id !== artifact.artifact_id), artifact]
    ...
    async publishReport(input) {
        ...
        const timestamp = now(request.timestamp);
        const current = this.store.loadState(request.report_id);
        if (current.approvalState.state !== "approved")
            throw new Error("Report approval is required before publish.");
        ...
        const exportHtml = this.store.writePublicationTransportText(request.report_id, publicationId, "published-report.html", typeof htmlExport.payload === "string" ? htmlExport.payload : Buffer.from(htmlExport.payload).toString("utf8"));
        ...
        const embedHtml = this.store.writePublicationTransportText(request.report_id, publicationId, "embed.html", `<!doctype html><html lang="ar" dir="rtl"><body><script type="application/json" id="report-embed">${JSON.stringify({
            publication_id: publicationId,
        ...
        const served = registerServedReportPublicationRoute(publicationId, manifest.filePath, publishState.filePath, embedPayload.filePath, embedHtml.filePath, exportHtml.filePath);
        ...
        const remoteBundle = publishRemoteBundle(`publications/${publicationId}`, [
        ...
        const transport = {
            ...
            served_embed_html_url: served.served_embed_html_url,
            served_export_html_url: served.served_export_html_url,
            backend_publication_root: node_path_1.default.join((0, store_1.defaultReportEngineBackendRoot)(process.cwd()), "publications", publicationId),
            ...
            backend_delivery_state_uri: backendDeliveryState.uri,
            gateway_bundle_root: node_path_1.default.join((0, store_1.defaultReportEngineBackendRoot)(process.cwd()), "publications", publicationId),
            gateway_bundle_ref: gatewayBundleRef,
        ...
        const manifestArtifact = contracts_1.ArtifactSchema.parse({
            contract: (0, contracts_1.contractEnvelope)("artifact"),
        ...
        const libraryAsset = request.publish_to_library
            ? contracts_1.LibraryAssetSchema.parse({
                contract: (0, contracts_1.contractEnvelope)("library"),
    ...
    scheduleReport(input) {
        ...
        const timestamp = now(request.timestamp);
        const current = this.store.loadState(request.report_id);
        const schedule = contracts_1.SharedScheduleSchema.parse({
            contract: (0, contracts_1.contractEnvelope)("schedule"),
    ...
    updateReportSchedule(input) {
        ...
        const current = this.store.loadState(reportId);
        const updatedSchedule = contracts_1.SharedScheduleSchema.parse({
            ...existing,
            next_run_at: request.next_run_at === undefined ? existing.next_run_at : request.next_run_at,
            state: request.enabled === undefined
                ? existing.state
                : request.enabled
                    ? "enabled"
                    : "disabled",
            publication_policy: {
                ...
                visibility_scope_ref: request.visibility_scope_ref === undefined
                    ? existing.publication_policy.visibility_scope_ref
                    : request.visibility_scope_ref
            },
            extension_refs: request.selective_regeneration_refs === undefined
    ...
    async runDueSchedules(runAt = now()) {
        ...
        for (const schedule of dueSchedules) {
            ...
            try {
                ...
                let degradedPublicationResult = null;
                    ...
                    while (!publicationResult && !degradedPublicationResult) {
                        try {
                            ...
                            orchestration = this.store.saveOrchestrationRecord({
                                ...
                                attempt_history: [
                                    ...orchestration.attempt_history.map((attempt, index, attempts) => index === attempts.length - 1
                            ...
                            const retrySchedulerDispatch = this.store.writeBackendSchedulerJson(orchestrationId, `dispatch-attempt-${activeDispatch.attempt_count}.json`, {
                                orchestration_id: orchestrationId,
                                queue_ref: queueRef,
                                queue_uri: schedulerQueue.uri,
                ...
                if (publicationResult?.transport) {
                    transportDeliveries.push(this.store.saveTransportDeliveryRecord({
                ...
                orchestration = this.store.saveOrchestrationRecord({
                    ...
                    attempt_history: orchestration.attempt_history.map((attempt, index, attempts) => index === attempts.length - 1
                        ? {
                            ...attempt,
                            state: degradedPublicationResult ? "degraded" : "completed",
                            finished_at: runAt,
                ...
                if (remoteSchedulerBundle) {
                    ...
                    const remoteDispatchUrl = remoteSchedulerBundle.assets[`dispatch_attempt_${activeDispatch.attempt_count}_json`]?.raw_url ??
                    ...
                    transportDeliveries.splice(0, transportDeliveries.length, ...transportDeliveries.map((delivery) => this.store.saveTransportDeliveryRecord({
                        ...delivery,
                ...
                const runnerStage = createExecutionStage({
                    ...
                    artifactRefs: publicationResult
                ...
                if (remoteSchedulerBundle) {
                    failedOrchestration = this.store.saveOrchestrationRecord({
                        ...
                        remote_dispatch_ref: remoteSchedulerBundle.assets[`dispatch_attempt_${activeDispatch.attempt_count}_json`]?.raw_url ??
    ...
    async publishDegradedReportOutput(input) {
        ...
        const manifestArtifact = this.store.writeAuxiliaryArtifact(request.report_id, contracts_1.ArtifactSchema.parse({
            contract: (0, contracts_1.contractEnvelope)("artifact"),
            ...
            tenant_ref: current.reportArtifact.tenant_ref,
            permission_scope: current.reportArtifact.permission_scope
        }), node_path_1.default.join("published", "degraded-publication.json"), JSON.stringify({ report_id: current.report.report_id, export_artifact_ref: exportResult.exportArtifact.artifact_id, reason: request.reason, published_at: timestamp }, null, 2));
        ...
        const remoteBundle = publishRemoteBundle(`publications/${id("publication", request.report_id, "degraded", timestamp)}`, [
            { key: "manifest", fileName: "degraded-publication.json", content: JSON.stringify(degradedTransportPayload, null, 2) },
            { key: "export", fileName: `degraded-export.${request.export_target}`, content: typeof exportResult.payload === "string" ? exportResult.payload : Buffer.from(exportResult.payload) }
        ], `Publish degraded report bundle ${request.report_id}`);
        const publication = contracts_1.PublicationSchema.parse({
            contract: (0, contracts_1.contractEnvelope)("publication"),
            publication_id: id("publication", request.report_id, "degraded", timestamp),
            ...
            target_ref: remoteBundle?.bundle_ref ?? manifestArtifact.storage_ref.uri,
            published_by: request.actor_ref,
            published_at: timestamp,
            permission_scope: current.reportArtifact.permission_scope,
            evidence_ref: id("evidence", request.report_id, "degraded-publish")
        ...
        const transport = remoteBundle
            ? {
                manifest_path: manifestArtifact.storage_ref.uri,
                manifest_uri: manifestArtifact.storage_ref.uri,
                publish_state_path: manifestArtifact.storage_ref.uri,
                publish_state_uri: manifestArtifact.storage_ref.uri,
                embed_payload_path: null,
                embed_payload_uri: null,
                embed_html_path: null,
                embed_html_uri: null,
                export_html_path: "",
                export_html_uri: "",
                outbox_path: "",
                outbox_uri: "",
                served_manifest_url: "",
                served_publish_state_url: "",
                served_embed_payload_url: null,
                served_embed_html_url: null,
                served_export_html_url: "",
                backend_publication_root: "",
                backend_publication_ref: remoteBundle.bundle_ref,
                backend_manifest_path: manifestArtifact.storage_ref.uri,
                backend_manifest_uri: manifestArtifact.storage_ref.uri,
                backend_access_state_path: "",
                backend_access_state_uri: "",
                backend_bundle_index_path: "",
                backend_bundle_index_uri: "",
                backend_delivery_state_path: "",
                backend_delivery_state_uri: "",
                gateway_bundle_root: "",
                gateway_bundle_ref: remoteBundle.bundle_ref,
                gateway_manifest_path: "",
                gateway_manifest_uri: "",
                gateway_consumable_ref: remoteBundle.bundle_ref,
                access_lifecycle_path: "",
                access_lifecycle_uri: "",
                delivery_receipt_path: "",
                delivery_receipt_uri: "",
                served_access_token: "",
                access_mode: request.export_target === "docx" ? "editable" : "read_only",
                remote_bundle_ref: remoteBundle.bundle_ref,
                remote_repository_ref: remoteBundle.repository_ref,
                remote_manifest_url: remoteBundle.assets.manifest?.raw_url ?? null,
                remote_publish_state_url: remoteBundle.assets.manifest?.raw_url ?? null,
                remote_embed_payload_url: null,
                remote_embed_html_url: null,
                remote_export_html_url: remoteBundle.assets.export?.public_url ?? null,
                remote_gateway_manifest_url: null,
                remote_access_lifecycle_url: null,
                remote_delivery_receipt_url: null
            }
            : null;
...
const dispatchReportAction = async (input) => {
    ...
    switch (request.action_id) {
        case "reports.create_report.v1":
            return engine.createReport(request.payload);
        case "reports.update_report.v1":
            return engine.updateReport(request.payload);
        case "reports.refresh_report.v1":
            return engine.refreshReport(request.payload);
        case "reports.compare_reports.v1":
            return engine.compareReports(request.payload);
        case "reports.review_report.v1":
            return engine.reviewReport(request.payload);
        case "reports.approve_report.v1":
            return engine.approveReport(request.payload);
        case "reports.publish_report.v1":
            return engine.publishReport(request.payload);
        case "reports.schedule_report.v1":
            return engine.scheduleReport(request.payload);
        case "reports.export_report_docx.v1":
            return engine.exportReportDocx(request.payload);
        case "reports.export_report_pdf.v1":
            return engine.exportReportPdf(request.payload);
        case "reports.export_report_html.v1":
            return engine.exportReportHtml(request.payload);
        case "reports.convert_report_to_presentation.v1":
            return engine.convertReportToPresentation(request.payload);
        case "reports.convert_report_to_dashboard.v1":
            return engine.convertReportToDashboard(request.payload);
        case "reports.publish_degraded_report_output.v1":
            return engine.publishDegradedReportOutput(request.payload);
        default:
            throw new Error(`Unsupported report action: ${request.action_id}`);
    }
};
exports.dispatchReportAction = dispatchReportAction;
const dispatchReportTool = async (input) => {
    ...
    return (0, exports.dispatchReportAction)({
        action_id: actionId,
        payload: request.payload,
        storage_dir: request.storage_dir
    });
};
exports.dispatchReportTool = dispatchReportTool;
const startReportPublicationService = (options) => {
    const store = new store_1.ReportEngineStore(options?.storageDir);
    ensureReportTransportServer();
...
exports.startReportPublicationService = startReportPublicationService;
const registerReportCapability = (runtime) => {
    runtime.registerCapability({
        capability_id: contracts_1.REPORT_CAPABILITY_ID,
        display_name: "Report Engine",
        package_name: "@rasid/report-engine",
        contract_version: "1.0.0",
        supported_action_refs: contracts_1.ReportActionRegistry.map((action) => action.action_id),
        supported_tool_refs: contracts_1.ReportToolRegistry.map((tool) => tool.tool_id)
    });
    runtime.registerManifest((0, capability_registry_1.createActionManifest)(contracts_1.REPORT_CAPABILITY_ID, "1.0.0", contracts_1.ReportActionRegistry, ["approval.default"], ["evidence.default"]));
    contracts_1.ReportToolRegistry.forEach((tool) => runtime.registerTool(tool));
};
exports.registerReportCapability = registerReportCapability;
const runReportRegressionSuite = async () => {
    const regressionRoot = node_path_1.default.join(process.cwd(), ".runtime", "report-engine-regression");
    await node_fs_1.promises.rm(regressionRoot, { recursive: true, force: true });
    const engine = new ReportEngine({
        storageDir: regressionRoot
    });
    const runId = id("report-regression", now().replace(/[^0-9]/g, ""));
    const importRoot = node_path_1.default.join(engine.store.rootDir, "import-sources");
    await node_fs_1.promises.mkdir(importRoot, { recursive: true });
    const docxPath = node_path_1.default.join(importRoot, "external-source.docx");
    const pdfPath = node_path_1.default.join(importRoot, "external-source.pdf");
    await node_fs_1.promises.writeFile(docxPath, Buffer.from(await (0, exports.createSampleDocx)("External Weekly Report", [])));
    await node_fs_1.promises.writeFile(pdfPath, Buffer.from((0, exports.createSamplePdf)([])));
    ...
    const presentationSyncedBlock = presentationConversion.state.contentBlocks.find((block) => Array.isArray(block.content_payload["source_metadata"]?.["downstream_capability"]) ? false : (block.content_payload["source_metadata"]?.["downstream_capability"] === "presentations"));
    ...
    const dashboardSyncedBlock = dashboardConversion.state.contentBlocks.find((block) => (block.content_payload["source_metadata"]?.["downstream_capability"] === "dashboards"));
...
exports.runReportRegressionSuite = runReportRegressionSuite;
